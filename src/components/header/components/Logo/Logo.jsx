...
const Logo = ({ to, phone, siteTitle, siteShortName, onClick }) => (
  <div className="inline-flex h-full items-center xl:mr-12">
    <a
      className="mr-4 inline-flex items-center text-gray-800 at-a at-a-undecorated"
      href={to}
      onClick={onClick}
    >
    ...
    <div className="flex flex-col text-left">
      <a href={to} onClick={onClick} className="bold text-lg text-gray-800 at-a at-a-undecorated">
        {siteShortName}
      </a>
